...
image::Bilder/Ableitungen/Waagrechte_Tangente_Ableitung_Sattelpunkt.png[Sattelpunkt mit Ableitung,width="50%", align="center", float="left", link="Bilder/Ableitungen/Waagrechte_Tangente_Ableitung_Sattelpunkt.png"]
