...
Die von Bakterien in einer Petrischale bedeckte Fläche soll durch die Funktion stem:[f(x)=e^x] beschrieben werden (stem:[x] in Stunden, stem:[f(x)] in stem:[cm^2]).
